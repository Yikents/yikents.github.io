      ...
      <div class="recordsaying-body-greet">
        ...
        <ul class="recordsaying-greet-lists">
          ...
          <li class="recordsaying-greet-item" @click="playerEvent">
            ...
            <audio
              src="http://mashengcai.oss-cn-beijing.aliyuncs.com/wanan/wanboy4.mp3"
            ></audio>
          </li>
          ...
          <li class="recordsaying-greet-item" @click="playerEvent">
            ...
            <audio
              src="http://mashengcai.oss-cn-beijing.aliyuncs.com/wanan/wanboy3.mp3"
            ></audio>
          </li>
          ...
          <li class="recordsaying-greet-item" @click="playerEvent">
            ...
            <audio
              src="http://mashengcai.oss-cn-beijing.aliyuncs.com/wanan/wanboy2.mp3"
            ></audio>
          </li>
